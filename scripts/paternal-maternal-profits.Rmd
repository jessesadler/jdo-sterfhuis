...
source("~/Documents/R/jdo-sterfhuis/scripts/functions.R")

transactions <- read_csv("~/Documents/R/jdo-sterfhuis/data/transactions.csv", col_types = cols(
  date = col_date(format = "%Y%m%d"))) %>% 
  select(from:to, date:denari) %>% 
  rename(l = livre, s = solidi, d = denari)
accounts <- read_csv("~/Documents/R/jdo-sterfhuis/data/accounts.csv") %>% 
